...
export default function VideoPlayer({ src }) {
  ...
  return (
    <div ref={playerContainerRef} className="relative w-full h-full group bg-black">
      ...
      {console.log("test 1")}
      <div 
        className="absolute bottom-0 left-0 right-0 p-3 bg-gradient-to-t from-black/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 cursor-auto z-10"
          ...
          <div className="flex items-center gap-x-4">
            ...
            <div className="flex items-center group/volume">
                ...
                <input
                    ...
                    className="w-0 group-hover/volume:w-24 h-[5px] ml-3 transition-all duration-300 cursor-pointer range-thumb pl-2"
                />
            </div>
